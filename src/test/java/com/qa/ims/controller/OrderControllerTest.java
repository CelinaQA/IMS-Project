...
public class OrderControllerTest {
	...
	public void updateAddTest() {
		...
		Mockito.doReturn(option).when(mock);
		Order order = new Order(1L, 1L, 1L, 3);
		Mockito.when(orderServices.updateAddItem(order, 1L, 3)).thenReturn(new Order(100L, 1L, Calendar.getInstance().getTime(), 1.00f, 1L, 3));
